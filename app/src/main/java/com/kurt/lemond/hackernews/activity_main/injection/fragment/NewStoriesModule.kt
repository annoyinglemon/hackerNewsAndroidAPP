...
class NewStoriesModule {
    ...
    @NewStoriesFragmentScope
    @NewStoriesPage
    fun provideStoriesRepository(newsStoriesService: NewStoriesService, @NewStoriesPage storyDetailsService: StoryDetailsService): StoriesRepository {
    ...
    @NewStoriesFragmentScope
    @NewStoriesPage
    fun provideViewModelFactory(@NewStoriesPage storiesRepository: StoriesRepository): StoriesFragmentViewModelFactory {
